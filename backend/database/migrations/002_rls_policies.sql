...
CREATE POLICY "Admins can update students" ON students FOR UPDATE USING (true);
...
CREATE POLICY "Admins can manage reports" ON skill_reports FOR ALL USING (true);
...
CREATE POLICY "Admins can manage registrations" ON bootcamp_registrations FOR ALL USING (true);
...
CREATE POLICY "Admins can view email logs" ON email_logs FOR ALL USING (true);
DROP POLICY IF EXISTS "Admins can view whatsapp logs" ON whatsapp_logs;
CREATE POLICY "Admins can view whatsapp logs" ON whatsapp_logs FOR ALL USING (true);
